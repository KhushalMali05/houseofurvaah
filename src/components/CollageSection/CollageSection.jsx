...
// TEMP: Craftsmanship section hidden — set to true to re-enable
const SHOW_CRAFTSMANSHIP_SECTION = false;
  ...
  return (
    <section className="editorial-collages-wrapper">
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      <div className="collage-block" id="collection">
          ...
          >
            ...
            <div className="left-subcol-stacked">
              <div className="tile-image-container half-height-container">
                ...
                />
                <img 
                  src="/assets/images/blue_gold_crop.png" 
                  alt="Blue and gold bodice front detail"
                  loading="lazy" 
                />
              </div>
              <div className="tile-image-container half-height-container">
      ...
      {/* =========================================================================
          ...
          ========================================================================= */}
      {SHOW_CRAFTSMANSHIP_SECTION && (
        <div className="collage-block craftsmanship-block" id="craftsmanship">
